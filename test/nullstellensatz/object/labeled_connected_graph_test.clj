...
(deftest check-expand-codes
  (is (match? [[1 1 0 0 0 0]] (connected/expand-codes 1 0)))
  (is (match? [[1 1 0 0 0 0] [2 1 0 0 0 0]] (connected/expand-codes 2 0)))
  (is (match? [[1 1 0 0 0 0] [2 1 0 0 0 0] [3 1 0 0 0 0]] (connected/expand-codes 3 0)))
  (is (match? [[1 1 0 0 0 0] [2 1 0 0 0 0] [3 2 0 0 0 0]] (connected/expand-codes 3 1)))
  (is (match? [[1 1 0 0 0 0] [2 1 0 0 0 0] [3 2 0 1 0 0]] (connected/expand-codes 3 2)))
  (is (match? [[1 1 0 0 0 0] [2 1 0 0 0 0] [3 2 0 2 0 0]] (connected/expand-codes 3 3))))
